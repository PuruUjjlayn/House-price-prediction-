...
location_df = pickle.load(open('House-price-prediction-\Pages\location_df.pkl','rb'))

cosine_sim1 = pickle.load(open('House-price-prediction-\Pages\cosine_sim1.pkl','rb'))
cosine_sim2 = pickle.load(open('House-price-prediction-\Pages\cosine_sim2.pkl','rb'))
cosine_sim3 = pickle.load(open('House-price-prediction-\Pages\cosine_sim3.pkl','rb'))
